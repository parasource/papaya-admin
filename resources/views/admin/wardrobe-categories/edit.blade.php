...
@section('content')
    ...
    {{ \Diglactic\Breadcrumbs\Breadcrumbs::render('admin.wardrobe-categories.edit', $wardrobeCategory) }}
        ...
        <div class="card mb-3">
            ...
            <div class="card-body pb-2">
                ...
                <div class="form-group">
                    ...
                    <input id="name" class="form-control @error('parent_category') is-invalid @enderror" name="parent_category" value="{{ old('parent_category', $wardrobeCategory->parent_category) }}" required>
